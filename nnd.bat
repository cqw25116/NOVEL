...
set UNZIP_URL_1=http://ftp.jaist.ac.jp/pub/sourceforge/u/un/unigw/unzip/5.50/unzip.exe
set UNZIP_URL_2=https://github.com/cqw25116/ncode/blob/master/filez/unzip.exe
...
:WGET_DL_2
  ...
  wget -q -N "%UNZIP_URL_1%"
  if not EXIST unzip.exe wget -q -N "%UNZIP_URL_2%"
